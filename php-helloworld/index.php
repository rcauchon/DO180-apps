...
$k8s_host = = $_ENV["KUBERNETES_SERVICE_HOST"];

print "k8s Host: " .$_ENV["KUBERNETES_SERVICE_HOST"]. Host: " .$_ENV["INFODB_SERVICE_HOST"].  " DBname:" .$_ENV["POSTGRESQL_DATABASE"]. " User:" .$_ENV["POSTGRESQL_USER"]. " Password:" . $_ENV["POSTGRESQL_PASSWORD"]. "<br>";
